...
/**
 * ImgTableController implements the CRUD actions for ImgTable model.
 */
class ImgTableController extends Controller
{
    ...
    /**
     * Lists all ImgTable models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new ImgTableSearch();
    ...
    /**
     * Displays a single ImgTable model.
     * @param integer $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('yii2-ajaxcrud', 'Create New')." ImgTable",
                ...
                return [
                    ...
                    'title'=> Yii::t('yii2-ajaxcrud', 'Create New')." ImgTable",
                    'content'=>'<span class="text-success">'.Yii::t('yii2-ajaxcrud', 'Create').' ImgTable '.Yii::t('yii2-ajaxcrud', 'Success').'</span>',
                    'footer'=> Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class'=>'btn btn-default pull-left', 'data-dismiss'=>"modal", 'data-bs-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing ImgTable model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('yii2-ajaxcrud', 'Update')." ImgTable #".$id,
    ...
    /**
     * Delete an existing ImgTable model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ImgTable model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the ImgTable model based on its primary key value.
