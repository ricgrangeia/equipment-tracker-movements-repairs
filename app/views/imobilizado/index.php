...
/* @var $searchModel app\models\ImobilizadoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app-imobilizado', 'Fixed Assets');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="imobilizado-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' Imobilizados','class'=>'btn btn-outline-primary']).
