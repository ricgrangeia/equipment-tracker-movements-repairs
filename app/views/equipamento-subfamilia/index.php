...
/* @var $searchModel app\models\EquipamentoSubfamiliaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Equipamento Subfamilias';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="equipamento-subfamilia-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' Equipamento Subfamilias','class'=>'btn btn-outline-primary']).
