...
/* @var $searchModel app\models\FuncionarioTipoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Funcionario Tipos';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="funcionario-tipo-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' Funcionario Tipos','class'=>'btn btn-outline-primary']).
